...
| 原則 | mago 対応 | ルール名 |
|------|-----------|---------|
| 不変性推奨 | ⚠️ 部分的 | `no-redundant-readonly` (readonly の冗長検出) |
...
| 原則 | mago 対応 | ルール名 |
|------|-----------|---------|
| 依存方向の制約 | 🔧 カスタム | `scripts/check-dependency-direction.php` |
| ドメイン層の外部依存排除 | ✅ mago 内蔵 | `no-global`, `no-request-variable`, `no-request-all` |
| Repository実装の配置 | 🔧 カスタム | `scripts/check-layer-placement.php` |
...
| 原則 | mago 対応 | ルール名 |
|------|-----------|---------|
| 値オブジェクトの不変性 | ✅ mago 内蔵 | `strict-types`, `check-missing-type-hints` |
...
| 原則 | mago 対応 | ルール名 |
|------|-----------|---------|
| 命名規約 | 🔧 カスタム | `scripts/check-repository-naming.php` |
...
| 原則 | mago 対応 | ルール名 |
|------|-----------|---------|
| ユースケース層への配置 | 🔧 カスタム | `scripts/check-layer-placement.php` |
